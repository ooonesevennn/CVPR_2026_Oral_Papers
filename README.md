...
preprints and code repositories where available.
...
| # | Category | Papers | arXiv | Code |
|---|---|---:|---:|---:|
| 1 | 3D Reconstruction, Geometry, Gaussian / Radiance Field, SfM, Registration | 45 | 33 | 7 |
| 2 | Generative Models, Diffusion, Image / Video / 3D Generation & Editing | 20 | 17 | 3 |
| 3 | Medical Imaging: VLM, Segmentation, Reconstruction, Registration | 15 | 10 | 4 |
| 4 | Segmentation, Detection, Recognition, Tracking, Correspondence | 30 | 21 | 10 |
| 5 | VLM / MLLM / Multimodal Reasoning / Safety / Benchmarks | 12 | 10 | 0 |
| 6 | Robotics, Embodied AI, Navigation, Manipulation, Autonomous Driving, World Models | 8 | 6 | 2 |
| 7 | Model Compression, Training Efficiency, Optimization, Federated Learning, Task Arithmetic | 13 | 9 | 4 |
| 8 | Privacy, Security, Watermarking, Copyright, Membership Inference | 5 | 3 | 0 |
| 9 | Datasets & Benchmarks | 11 | 10 | 2 |
| — | **Total (de-dup)** | **141** | **102** | **29** |
...
If you spot a missing arXiv or GitHub link, feel free to open an [issue](https://github.com/ooonesevennn/CVPR_2026_Oral_Papers/issues) or submit a [pull request](https://github.com/ooonesevennn/CVPR_2026_Oral_Papers/pulls).
...
## 8. Privacy, Security, Watermarking, Copyright, Membership Inference
